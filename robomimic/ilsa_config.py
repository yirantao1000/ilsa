...
class ILSAConfig(BaseConfig):
    ALGO_NAME = "ilsa"

    def train_config(self):
        super(ILSAConfig, self).train_config()
    ...
    def algo_config(self):
        ...
        """
        self.algo.task = ''
        self.algo.loc_only = False
        self.algo.upgraded = False
        self.algo.latest = False

        self.algo.vanilla = False
        self.algo.xbox_threshold = 0.25

        self.algo.finish = False
        self.algo.finish_separate = False

        self.algo.finish_weight = 0
        self.algo.finish_layer_dims = []

        self.algo.real = True
        self.algo.limit = False
        self.algo.end2end = True

        self.algo.incremental = False
        self.algo.previous_ckpt_path = ""

        self.algo.partial_incremental = False
        self.algo.incre_transformer_only = False
        self.algo.incre_no_transformer = False

        self.algo.manual_sample_incre = False
        self.algo.manual_sample_modified = False

        self.algo.incremental_loss_all = False
        self.algo.user_loss_modified = False

        self.algo.middle_gt_wrong = False
        self.algo.final_gt_wrong = False

        self.algo.middle_gt_all = False
        self.algo.no_middle_gt = False
        self.algo.final_gt_all = False

        self.algo.reweight = False
        self.algo.fancy_reweight = False


        self.algo.chunk = False #dataset_factory in train_utils need this
        self.algo.chunk_num = 0
        self.algo.chunk_deal_last = None

        

        # self.algo.transformer.num_layers_first = 6 
        # self.algo.transformer.num_layers_second = 6 

        self.algo.gt_weight = 1.
        self.algo.user_weight = 1.
        self.algo.wrong_user_loss = False
        self.algo.middle_gt_weight = 0

        self.algo.wrong_direction_loss = 1
        self.algo.squared_wrong_direction_loss = 0

        self.algo.major_direction_loss = 0
        self.algo.squared_major_direction_loss = 0
